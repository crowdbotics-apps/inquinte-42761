"""
Django settings for inquinte_42761 project.
...
ROOT_URLCONF = 'inquinte_42761.urls'
...
WSGI_APPLICATION = 'inquinte_42761.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "inquinte_42761 API",
    "DESCRIPTION": "API documentation for inquinte_42761 App",
    "VERSION": "v1",
}
